...
public class EndpointResult extends JGOResult
{
    public int port;
    public String canonical_name, username, description, myproxy_server, activated, name;
    public String expire_time, is_public, ls_link, scheme, subject, hostname, uri;
    public String hosts, subjects, status, expires;
    public boolean list_verbose, list_public, username_matches, is_globus_connect;
        ...
        throws Exception
    {
        ...
        if ((jobj.get("expire_time") != null) && !jobj.get("expire_time").equals("null"))
        {
    ...
    public String toString()
    {
        ...
        if ((this.username_matches == true) || (this.list_public == true))
        {
